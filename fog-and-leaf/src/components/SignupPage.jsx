...
const SignupPage = () => {
  ...
  //       return;
  //     }
  //     // Save token and user info (example: localStorage, or context)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call backend API for signup using axiosInstance
      ...
      // Handle server errors / validation errors
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Create your account and start your tea journey with us
          </p>
        </div>
